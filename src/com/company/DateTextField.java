...
//---------------
//---------------    TAKEN FROM https://stackoverflow.com/questions/11736878/display-calendar-to-pick-a-date-in-java
//---------------
...
class DateTextField extends JTextField {
    ...
    public Date getDate() {
        try {
            return this.getDefaultDateFormat().parse(getText());
